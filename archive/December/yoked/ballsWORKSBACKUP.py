...
class Particle:
    ...
    def __init__(self, x, y, vx, vy, radius=0.10, styles=None):
...
class Simulation:
    ...
    def __init__(self, n, radius=0.1, styles=None):
...
if __name__ == '__main__':
    nparticles = 5
    radii = [0.03,0.03,0.03,0.03,0.03]
    print(radii)
    styles = {'edgecolor': 'C0', 'linewidth': 2, 'fill': None}
    sim = Simulation(nparticles, radii, styles)
    sim.do_animation(save=False)
...
#     nparticles = 5
#     radius = .6
#     radii = np.full(nparticles, radius)
#     # print(radii)
#     styles = {'edgecolor': 'C0', 'linewidth': 2, 'fill': None}
#     sim = Simulation(nparticles, radii, styles)
#     sim.do_animation(save=False)