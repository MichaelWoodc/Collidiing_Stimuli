...
bounce_box_right = window_width - margin_right
bounce_box_top = window_height - margin_top
...
class Simulation:
    def __init__(self, nparticles, radius=100): #def __init__(self, nparticles, radius=10):
